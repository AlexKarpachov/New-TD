...
public class Enemy2 : EnemyBase
{
    void Start()
    {
        ...
        Waypoints waypoints = GameObject.FindGameObjectWithTag("Route1").GetComponent<Waypoints>(); // в майбутньому реалізувати це через посиланя (Waypoints route1, route2) у WaveManager
